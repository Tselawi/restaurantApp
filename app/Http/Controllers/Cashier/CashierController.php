...
class CashierController extends Controller
{
    ...
    private function getSaleDetails($sale_id){
       ...
       <table class="table table-stripped table-dark">
            ...
            foreach($saleDetails as $saleDetail){
                ...
                <tr>
                    ...
                    if($saleDetail->status == "noConfirm"){
                        ...
                        $html .='<td><a data-id="'.$saleDetail->id.'" class="
                        btn btn-danger btn-delete-saledetail"><i class="far
                        fa-trash-alt"></i></td>';
                    }else{ // status == "confirm"
           ...
           if($showBtnPayment){
            ...
            btn-block btn-payment" data-toggle="modal" data-target="#exampleModal">Payment</botton>';
           }else{
            $html .= '<button data-id="'.$sale_id.'" class="btn btn-warning
            btn-block btn-confirm-order">Confirm Order</botton>';
           }
    ...
    public function deleteSaleDetail(Request $request)
    {
        ...
        $sale->save();
        // check if there any saledetail having the sale
