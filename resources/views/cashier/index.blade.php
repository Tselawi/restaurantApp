...
<script>
    $(document).ready(function(){
        ...
        $("#table-detail").on("click", ".btn-table", function(){
            ...
            // to change table datail under the button view table
        ...
        // when user click to the payment button
        $("#order-detail").on("click", ".btn-payment", function(){
            ...
            //to clear the amount after the payment
            $('#recieved-amount').val('');
            $('.changeAmount').html('');
            // to use sale id to complete the payment
        ...
        $("#recieved-amount").keyup(function(){
            ...
            var reciecedAmount = $(this).val();
            var changeAmount = reciecedAmount - totalAmount;
